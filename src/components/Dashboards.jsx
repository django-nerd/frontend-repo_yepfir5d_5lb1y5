  ...
  return (
    <section id="dashboards" className="py-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-white/75 mt-2">Tailored overviews for Executives, Team Leads, and Employees.</p>
        ...
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          ...
          <div className="rounded-2xl overflow-hidden border border-white/10 bg-white/[0.04]">
            ...
            <div className="p-5 space-y-3 text-white/85 text-sm">
        ...
        <div id="assistant" className="mt-8 rounded-2xl border border-violet-500/30 bg-gradient-to-br from-violet-500/10 to-amber-500/10 p-5">
          ...
          <p className="text-white/75 text-sm mt-1">Actionable insights from your live data.</p>
          <div className="mt-4 text-white/90 text-sm leading-relaxed min-h-[64px]">
